          ...
          {state.notif.dnd && (
            <>
              <div style={{ display: 'flex', gap: 8 }}>
                <input aria-label="Hora desde" type="time" value={state.notif.dndFrom} onChange={setDndFrom} style={{ flex: 1, minWidth: 0, padding: 10, borderRadius: 10, border: '0.5px solid var(--border)', fontSize: 16, background: 'var(--surface2)' }} />
                <input aria-label="Hora hasta" type="time" value={state.notif.dndTo} onChange={setDndTo} style={{ flex: 1, minWidth: 0, padding: 10, borderRadius: 10, border: '0.5px solid var(--border)', fontSize: 16, background: 'var(--surface2)' }} />
              </div>
