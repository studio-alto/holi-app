...
export default function MedFormModal({ title, form, onChange, onCancel, onSave }) {
  ...
  return (
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 60, background: 'rgba(0,0,0,0.35)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', pointerEvents: 'auto' }}>
      <div style={{ background: 'var(--bg)', width: '100%', maxWidth: 600, borderRadius: '22px 22px 0 0', padding: '18px 20px 26px', maxHeight: '90%', overflowY: 'auto' }}>
