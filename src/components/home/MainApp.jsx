...
export default function MainApp({ state, update, addToast, resetState }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: '100%' }}>
      ...
      <div className="fade-in-up" style={{ flex: 1, overflowY: 'auto', padding: '16px 20px 20px', display: 'flex', flexDirection: 'column', gap: 16, background: 'var(--bg)' }}>
        {showQuote && (
      ...
      <BottomNav isActive={isTabActive} onSelect={handleTabSelect} />
